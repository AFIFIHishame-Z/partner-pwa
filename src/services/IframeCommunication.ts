...
export interface StartSpeechRecognitionResponse {
  requestId?: string;
  type: "START_SPEECH_RECOGNITION_RESPONSE";
  success: boolean;
  error?: string;
}

export interface StopSpeechRecognitionResponse {
  requestId?: string;
  type: "STOP_SPEECH_RECOGNITION_RESPONSE";
  success: boolean;
  text?: string;
  error?: string;
}
